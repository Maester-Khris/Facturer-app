    <div class="pd-ltr-20">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-8">
                    <h4 class="font-20 weight-500 mb-10 text-capitalize">
                        Welcome back Administrator<div class="weight-600 font-30 text-blue">Johnny Brown!</div>
                    </h4>
                ...
                <div class="card-box height-100-p widget-style1">
                    <div class="d-flex flex-wrap align-items-center">
                        ...
                        <div class="widget-data">
                            ...
                            <div class="weight-600 font-14">Fournisseur</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-box height-100-p widget-style1">
                    <div class="d-flex flex-wrap align-items-center">
                        ...
                        <div class="widget-data">
                            ...
                            <div class="weight-600 font-14">Ventes</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-box height-100-p widget-style1">
                    <div class="d-flex flex-wrap align-items-center">
                        ...
                        <div class="widget-data">
                            ...
                            <div class="weight-600 font-14">Revenues</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- activity and lead target -->
        <div class="row">
            <div class="col-xl-8 mb-30">
                <div class="card-box height-100-p pd-20">
                    <h2 class="h4 mb-20">Recentes ventes</h2>
                    <div id="chart5"></div>
                </div>
            </div>
            <div class="col-xl-4 mb-30">
                <div class="card-box height-100-p pd-20">
                    <h2 class="h4 mb-20">Etats du Stock</h2>
                    <div id="chart6"></div>
                </div>
            </div>
        </div>
