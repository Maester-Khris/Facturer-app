...
<link rel="icon" type="image/png" sizes="32x32" href="{{ URL::to('vendors/images/favicon-32x32.png') }}">
<link rel="icon" type="image/png" sizes="16x16" href="{{ URL::to('vendors/images/favicon-16x16.png') }} "> --}}
...
<link rel="stylesheet" type="text/css" href="{{ URL::to('src/plugins/datatables/css/dataTables.bootstrap4.min.css') }}">
